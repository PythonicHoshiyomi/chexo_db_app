...
class ApiTest(APITestCase, URLPatternsTestCase):
    ...
    def test_create_dojo(self):
        ...
        self.assertEqual(response.status_code, 200)
        self.assertEqual(DojoList.objects.all().count(), 1)
        self.assertEqual(DojoList.objects.get().dojo_name, "Dojo 1")
    ...
    def test_create_member_(self):
        ...
        self.assertEqual(response.status_code, 200)
        self.assertEqual(MemberList.objects.all().count(), 1)
        self.assertEqual(MemberList.objects.get().name, "member")
    ...
    def test_update_dojo(self):
        ...
        self.assertEqual(response.status_code, 200)
        self.assertEqual(DojoList.objects.get(pk=1).dojo_name, "Dojo 2")
    ...
    def test_update_member(self):
        ...
        self.assertEqual(response.status_code, 200)
        self.assertEqual(MemberList.objects.all().count(), 1)
        self.assertEqual(MemberList.objects.get(dojo_id=1, pk=1).name, "Udin")
    ...
    def test_delete_dojo(self):
        ...
        self.assertEqual(response.status_code, 200)
        self.assertEqual(DojoList.objects.all().count(), 0)
    ...
    def test_delete_member(self):
        ...
        response = self.client.delete(url)
        self.assertEqual(response.status_code, 200)
        self.assertEqual(MemberList.objects.all().count(), 0)
